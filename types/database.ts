  ...
  public: {
    Tables: {
      ...
      materi_pelajaran: {
        ...
        Relationships: [
          {
            foreignKeyName: "materi_pelajaran_kursus_id_fkey"
            columns: ["kursus_id"]
            isOneToOne: false
            referencedRelation: "kursus"
            referencedColumns: ["id"]
      ...
      progres_belajar: {
        ...
        Relationships: [
          {
            foreignKeyName: "progres_belajar_materi_id_fkey"
            columns: ["materi_id"]
            isOneToOne: false
            referencedRelation: "materi_pelajaran"
            referencedColumns: ["id"]
          },
          {
            foreignKeyName: "progres_belajar_pendaftaran_id_fkey"
            columns: ["pendaftaran_id"]
            isOneToOne: false
            referencedRelation: "pendaftaran_kursus"
            referencedColumns: ["id"]
          },
        ]
      }
