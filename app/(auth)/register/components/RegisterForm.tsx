...
export default function RegisterPage() {
  return (
    <div className="flex flex-col items-center justify-center min-h-screen text-center p-4">
      <h1 className="text-2xl font-bold mb-4">Fitur Registrasi Belum Tersedia</h1>
      <p className="text-silver mb-6">Fitur pendaftaran akun baru akan segera kami buka. Terima kasih atas kesabaran Anda!</p>
      <Link href="/" className="text-gold hover:underline">
        Kembali ke Beranda
      </Link>
      {/* // Kode form lama Anda bisa dikomentari di sini
