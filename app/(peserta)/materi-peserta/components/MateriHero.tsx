...
export default function MateriHero({ user }: MateriHeroProps) {
        ...
        <ScrollReveal>
          <div className="flex flex-col md:flex-row items-center justify-between">
            <div className="text-center md:text-left mb-8 md:mb-0">
              ...
              <p className="text-silver text-lg max-w-2xl">Akses dan pelajari materi pembelajaran dari kursus yang Anda ikuti. Tingkatkan kemampuan Anda dengan materi berkualitas.</p>
            </div>

            <div className="bg-white/10 backdrop-blur-lg rounded-2xl p-6 border border-white/20 shadow-xl">
              <div className="text-center">
                <div className="text-2xl font-bold text-gold mb-1">Materi Pembelajaran</div>
                <div className="text-silver text-sm">Akses semua materi kursus Anda</div>
              </div>
            </div>
          </div>
        </ScrollReveal>
