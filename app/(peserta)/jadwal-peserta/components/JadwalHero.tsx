...
export default function JadwalHero({ user }: JadwalHeroProps) {
        ...
        <ScrollReveal>
          <div className="flex flex-col md:flex-row items-center justify-between">
            <div className="text-center md:text-left mb-8 md:mb-0">
              ...
              <p className="text-silver text-lg max-w-2xl">Kelola jadwal pelatihan Anda dan pantau progres pembelajaran dengan mudah.</p>
            </div>
