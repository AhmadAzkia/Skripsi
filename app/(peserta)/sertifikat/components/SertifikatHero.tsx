...
interface SertifikatHeroProps {
  user: SessionUser;
}

export default function SertifikatHero({ user }: SertifikatHeroProps) {
        ...
        <ScrollReveal>
          <div className="flex flex-col md:flex-row items-center justify-between">
            <div className="text-center md:text-left mb-8 md:mb-0">
              ...
              <p className="text-silver text-lg max-w-2xl">Kelola dan unduh sertifikat yang telah Anda peroleh dari berbagai pelatihan yang telah diselesaikan.</p>
            </div>

            <div className="bg-white/10 backdrop-blur-lg rounded-2xl p-6 border border-white/20 shadow-xl">
              <div className="text-center">
                <div className="text-2xl font-bold text-gold mb-1">Sertifikat</div>
                <div className="text-silver text-sm">Pencapaian Anda</div>
              </div>
            </div>
          </div>
        </ScrollReveal>
