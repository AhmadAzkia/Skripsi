        ...
        <ScrollReveal>
          <div className="text-center mb-8">
            <div className="inline-flex items-center gap-3 mb-4">
              ...
              <h1 className="text-4xl font-bold bg-linear-to-r from-navy to-gold bg-clip-text text-transparent">Kelola Blog</h1>
            </div>
          ...
          <ScrollReveal delay={100}>
            <div className="bg-white rounded-xl shadow-lg border border-navy/10 p-6 hover:shadow-xl transition-all duration-300">
              <div className="flex items-center justify-between">
                ...
                <div className="w-12 h-12 bg-linear-to-br from-navy/10 to-gold/10 rounded-lg flex items-center justify-center">
