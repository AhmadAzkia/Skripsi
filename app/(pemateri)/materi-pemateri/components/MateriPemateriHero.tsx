...
interface MateriPemateriHeroProps {
  user: SessionUser;
}

export default function MateriPemateriHero({ user }: MateriPemateriHeroProps) {
        ...
        <ScrollReveal>
          <div className="flex flex-col md:flex-row items-center justify-between">
            <div className="text-center md:text-left mb-8 md:mb-0">
              ...
              <p className="text-silver text-lg max-w-2xl">Kelola dan atur materi pembelajaran Anda. Buat konten berkualitas untuk membantu peserta mencapai tujuan belajar mereka.</p>
            </div>
