...
import MateriPemateriContainer from "./components/MateriPemateriContainer";
...
export default async function MateriPemateriPage() {
  ...
  try {
    ...
    return <MateriPemateriContainer user={sessionUser} />;
  } catch (error) {
    console.error("Error in MateriPemateriPage:", error);
    redirect("/login");
  }
}
