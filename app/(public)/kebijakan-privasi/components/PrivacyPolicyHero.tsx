...
export default function PrivacyPolicyHero() {
  return (
    <section className="bg-linear-to-br from-navy via-navy/95 to-navy/90 py-16 md:py-24 relative overflow-hidden">
      {/* Background Pattern */}
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative">
        <ScrollReveal>
          ...
          <p className="text-xl md:text-2xl text-silver mb-8 max-w-3xl mx-auto leading-relaxed">Komitmen kami untuk melindungi privasi dan keamanan data pribadi Anda dengan standar keamanan tertinggi</p>
