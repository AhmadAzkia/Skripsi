...
export default function HomeHero() {
  return (
    <section className="bg-linear-to-br from-navy via-navy to-blue-900 py-16 md:py-24 relative overflow-hidden">
      {/* Background Pattern */}
      <div className="absolute inset-0 opacity-10">
        ...
        <div className="absolute bottom-0 right-0 w-full h-fullbg-[radial-gradient(circle_at_25%_25%,rgba(212,175,55,0.1)_0%,transparent_50%)]"></div>
      </div>
