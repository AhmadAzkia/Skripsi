...
const Input = forwardRef<HTMLInputElement, InputProps>(({ label, error, helperText, leftIcon, rightIcon, className = "", ...props }, ref) => {
  const baseClasses = "w-full px-3 py-2 border rounded-lg focus:ring-2 focus:ring-navy/20 focus:border-navy disabled:bg-gray-50 disabled:text-gray-500 transition-colors";
  ...
  return (
    <div className="space-y-1">
      ...
      <div className="relative">
        ...
        <input ref={ref} className={`${baseClasses} ${errorClasses} ${paddingClasses} ${className}`} {...props} />
